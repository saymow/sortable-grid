...
import { GridConfig } from './classes/gridConfig.js'
import {
  SortableGridElement,
...
export default class SortableGrid {
   ...
   * @param {PaginatorToolKit} paginatorToolKitData
   */
  constructor(
    stageEl,
    stageWrapperEl,
    ...
    this.cellsFactory = new CellsFactory(gridConfig, this.storeMap)
    ...
    this.virtualGrid = new VirtualGrid(
      ...
      this.rectFactory,
      this.cellsFactory,
      new GridRectSource(containmentEl, this.rectFactory),
      this.mainStage,
    )
